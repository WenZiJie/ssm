...
<body class="layout-center ask-new-layout">
	...
	<script type="text/javascript" src="http://r.baiduqa.com/static/js/ajaxfileupload.js"></script>
	<script type="text/javascript" src="http://r.baiduqa.com/static/js/question.js"></script>
