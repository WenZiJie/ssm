...
public class CommentController {
	...
	@RequestMapping("/add")
	@ResponseBody
	public String addComment(Comment comment) throws RemoteException {
		//添加评论时间时间
	...
	@GetMapping("/{replyId}")
	@ResponseBody
	public Map<String, Object> queryCommByReplyId(@PathVariable("replyId") Integer replyId,Integer startIndex,Integer pageSize) throws RemoteException {
